...
/* @var $searchModel app\models\search\TipoClienteSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Tipo Cliente');
$this->params['breadcrumbs'][] = Yii::t('app', 'Tipos Cliente');
...
<div class="tipo-cliente-index">
    ...
    <div class="form-group">
        ...
        <div class="pull-right">
            ...
            <?= $form->field($searchModel, 'search')->textInput(['data-toggle' => 'tooltip', 'title' => 'Pesquisa por descrição ou código'])->label('Pesquisar: ') ?>
            <?php ActiveForm::end(); ?>
        </div>
    </div>
