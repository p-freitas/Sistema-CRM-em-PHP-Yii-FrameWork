...
/* @var $searchModel app\models\search\TipoDocumentoSearch */
...
<div class="tipo-documento-index">
    ...
    <div class="form-group">
        ...
        <div class="pull-right">
            ...
            <?= $form->field($searchModel, 'search')->textInput(['data-toggle' => 'tooltip', 'title' => 'Pesquisa por ID, tipo ou descrição'])->label('Pesquisar: ') ?>
            <?php ActiveForm::end(); ?>
        </div>
    </div>
