...
/* @var $searchModel app\models\search\CargoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Cargos');
$this->params['breadcrumbs'][] = Yii::t('app', 'Cargos');
?>
<div class="cargo-index">
    ...
    <div class="form-group">
        <?= Html::a('<i class="fa fa-plus-circle"></i> Novo cargo', ['create'], ['class' => 'btn btn-success', 'data-pjax' => 0]) ?>
