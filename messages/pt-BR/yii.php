...
return [
    ...
    'Home' => 'Página Inicial',
    'Invalid compare value date format: {value}' => 'Formato de data inválido para verificação: {value}',
    'Invalid data received for parameter "{param}".' => 'Dados inválidos recebidos para o parâmetro "{param}".',
    'Invalid value date format: {value}' => 'Formato de data inválido: {value}',
    ...
    'The combination {values} of {attributes} has already been taken.' => 'A combinação {values} de {attributes} já foi feita',
    ...
    'Unknown alias: -{name}' => 'Apelido desconhecido: -{name}',
    ...
    '{delta, plural, =1{1 month} other{# months}}' => '{delta, plural, =1{1 mês} other{# mês}}',
